...
namespace AssignThurs.Areas.Tatoo.Controllers
{
    ...
    public class ArtistsController : Controller
    {
        ...
        // GET: Tatoo/Artists/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Tatoo/Artists/Create
