...
namespace MyAspDemos.Areas.Demo.Controllers
{
    ...
    public class ArtistsController : Controller
    {
        ...
        // GET: Demo/Artists/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Demo/Artists/Create
